...
const VerdaContext = createContext();


const VerdaContextProvider = ({ children }) => {
  ...
  return (
    <VerdaContext.Provider value={{
      ...
      {children}
    </VerdaContext.Provider>
  );
}

export { VerdaContext, VerdaContextProvider }
